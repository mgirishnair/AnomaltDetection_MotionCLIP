#!/usr/bin/env python3
"""
Fine-tune MotionCLIP for PerMo healthy-vs-condition anomaly detection with truly unseen-action testing.
What this script does:
  ...
  2. Creates prompts per action:
       ...
       anomaly class : "{condition} {action}"
  ...
  6. Runs inference on seen-action and truly unseen-action test sets using healthy/condition prompt similarity.
...
def main() -> None:
    ...
    required_cols = [args.path_col, args.action_col, args.condition_col, args.label_col]
    ...
    split_summary = {
        ...
        "all_conditions": sorted(df["_condition_norm"].unique().tolist()),
