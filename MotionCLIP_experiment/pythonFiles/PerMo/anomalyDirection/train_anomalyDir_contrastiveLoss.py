...
def train_direction_epoch(
    ...
    scaler = torch.cuda.amp.GradScaler(enabled=use_amp)
    totals = {"loss": 0.0, "binary": 0.0, "direction": 0.0, "contrastive": 0.0, "action": 0.0, "n": 0.0}
    for batch in loader:
...
def main() -> None:
    ...
    model_info = {
        "method": "shared_anomaly_direction_no_stage1_no_motion_projectors_no_action_preservation_with_anchor_contrastive",
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print(
            ...
            f"act_disabled={losses['action']:.4f} "
