...
#SBATCH --job-name="motionclip_computeEmbeddings_allData_lessNeg"
...
#SBATCH --array=0-5
#SBATCH --output=/scratch/mgirishnair/Thesis/SLURM_logs/embeddings/allData/lessNeg/%x_%A_%a.out
...
FINETUNE_DIR="/scratch/mgirishnair/Thesis/MotionCLIP_experiment/finetune/contrastive_allData/lessNeg/global_all_classes"
...
EMBEDDINGS_DIR="/scratch/mgirishnair/Thesis/MotionCLIP_experiment/embeddings/allData/lessNeg"
