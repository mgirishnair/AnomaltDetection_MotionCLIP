...
#SBATCH --job-name="motionclip_computeEmbeddings_NTU120_lessNeg"
...
CHECKPOINT_PATH="/scratch/mgirishnair/Thesis/MotionCLIP_experiment/finetune/ntu120/lessNeg/ntu120/global_all_classes_train80/motionclip_finetuned_lessNeg.pth"

EMBEDDINGS_DIR="/scratch/mgirishnair/Thesis/MotionCLIP_experiment/embeddings/NTU120/lessNeg"
