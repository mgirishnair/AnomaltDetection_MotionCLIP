...
#SBATCH --job-name="computeEmbeddings_NTU120_fullContras_allSplits"
...
#SBATCH --array=0-2
#SBATCH --output=/scratch/mgirishnair/Thesis/SLURM_logs/embeddings/NTU120/allSplits/fullContras/%x_%A_%a.out
...
#FINETUNE_DIR="/scratch/mgirishnair/Thesis/MotionCLIP_experiment/finetune/ntu_1-120/fullContras/ntu_allClasses_lessSample/global_all_classes_train80"
#SPLIT_INDICES_PATH="${FINETUNE_DIR}/global_split_indices.npz"
CHECKPOINT_PATH="/scratch/mgirishnair/Thesis/MotionCLIP_experiment/finetune/ntu120/fullContras/ntu120/global_all_classes_train80/motionclip_finetuned_fullContras.pth"

EMBEDDINGS_DIR="/scratch/mgirishnair/Thesis/MotionCLIP_experiment/embeddings/NTU120/fullContras/lowOverlap"
...
python /scratch/mgirishnair/Thesis/MotionCLIP_experiment/pythonFiles/embeddings/finetuned_embeddings_allDataNTU120.py \
  --x_path "${X_PATH}" \
  --y_path "${Y_PATH}" \
