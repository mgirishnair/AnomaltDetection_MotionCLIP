#!/bin/bash
#SBATCH --job-name="Train_anomalyDir_e2eMLP_unseenContentActorStyles_2"
...
OUT_DIR="/scratch/mgirishnair/Thesis/MotionCLIP_experiment/PerMo/anomalyDirection/e2eMLP/unseenContentActorStyles/2_UnseenStyles/Seed${ORDER_SEED}"
