#!/bin/bash
#SBATCH --job-name="Train_anomalyDir_e2eMLP_seen"
...
OUT_DIR="/scratch/mgirishnair/Thesis/MotionCLIP_experiment/PerMo/anomalyDirection/e2eMLP/seen/Seed${ORDER_SEED}"
