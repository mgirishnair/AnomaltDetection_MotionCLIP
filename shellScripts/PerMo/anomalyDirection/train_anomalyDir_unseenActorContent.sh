#!/bin/bash
#SBATCH --job-name="Train_anomalyDir_e2eMLP_unseenContentActor"
...
OUT_DIR="/scratch/mgirishnair/Thesis/MotionCLIP_experiment/PerMo/anomalyDirection/e2eMLP/unseenContentActors/Seed${ORDER_SEED}"
