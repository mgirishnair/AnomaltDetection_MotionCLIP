#!/bin/bash
#SBATCH --job-name=Finetune_unseenContentActorStyles_2
...
OUT_DIR="/scratch/mgirishnair/Thesis/MotionCLIP_experiment/PerMo/finetune/realConditionPrompts/equalSamplesCondition/differentOrderSeeds/unseenContentActorStyles/2_UnseenStyles/Seed_${ORDER_SEED}"
