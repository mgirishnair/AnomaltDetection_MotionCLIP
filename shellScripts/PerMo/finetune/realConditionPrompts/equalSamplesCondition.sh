...
OUT_DIR="/scratch/mgirishnair/Thesis/MotionCLIP_experiment/PerMo/finetune/realConditionPrompts/equalSamplesCondition/differentOrderSeeds/seen/Seed_${ORDER_SEED}"
