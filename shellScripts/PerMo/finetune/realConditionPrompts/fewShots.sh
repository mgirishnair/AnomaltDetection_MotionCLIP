#!/bin/sh
#SBATCH --job-name="BalancedNormAnomaly_Condition_zeroShot"
...
python /scratch/mgirishnair/Thesis/MotionCLIP_experiment/pythonFiles/PerMo/finetune/realConditionPrompts/fewShots.py \
    ...
    --output_dir /scratch/mgirishnair/Thesis/MotionCLIP_experiment/PerMo/finetune/realConditionPrompts/balancedNormAnomaly/Condition/fewShots/zeroShot \
    --epochs 0 \
    --num_workers 2 \
    --batch_size 32 \
    --lr 1e-5 \
