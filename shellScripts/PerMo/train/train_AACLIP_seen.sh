#!/bin/bash
#SBATCH --job-name="Train_AACLIP_SeedArray_seen"
...
OUT_DIR="/scratch/mgirishnair/Thesis/MotionCLIP_experiment/PerMo/train_differentSplitSeeds/noContrastiveLoss/seen/Seed${ORDER_SEED}"
