#!/bin/bash
#SBATCH --job-name="Train_AACLIP_SeedArray_unseenContentActorStyles_4"
...
OUT_DIR="/scratch/mgirishnair/Thesis/MotionCLIP_experiment/PerMo/train_differentSplitSeeds/noContrastiveLoss/unseenContentActorStyles/4_UnseenStyles/Seed${ORDER_SEED}"
