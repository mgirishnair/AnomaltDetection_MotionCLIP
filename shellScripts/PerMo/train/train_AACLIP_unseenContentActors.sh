#!/bin/bash
#SBATCH --job-name="Train_AACLIP_SeedArray_unseenContentActors"
...
OUT_DIR="/scratch/mgirishnair/Thesis/MotionCLIP_experiment/PerMo/train_differentSplitSeeds/noContrastiveLoss/unseenContentActors/Seed${ORDER_SEED}"
