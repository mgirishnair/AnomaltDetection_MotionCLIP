...
#SBATCH --job-name="optuna_motionclip_global_FullcontrastiveLoss"
...
mkdir -p /scratch/mgirishnair/Thesis/MotionCLIP_experiment/optuna_dbs/global/fullContrastiveLoss
mkdir -p /scratch/mgirishnair/Thesis/MotionCLIP_experiment/optuna_runs/global/fullContrastiveLoss
...
python /scratch/mgirishnair/Thesis/MotionCLIP_experiment/pythonFiles/finetune/tune_motionclip_optuna_allData.py \
  ...
  --storage "sqlite:////scratch/mgirishnair/Thesis/MotionCLIP_experiment/optuna_dbs/global/fullContrastiveLoss/motionclip_global_contrastive.db" \
  --n_trials 30 \
  ...
  --work_dir optuna_runs/global/fullContrastiveLoss \
