#!/bin/bash
#
#SBATCH --job-name="compute_anomaly"
...
python motionCLIP_anomalyDetection_computeAnomaly.py \
    --embeddings_path "/scratch/mgirishnair/MotionCLIP_experiment/embeddings/motionclip_embeddings_${split}_allData.npz" \
