...
SCRIPT_PATH="/scratch/mgirishnair/Thesis/MotionCLIP_experiment/pythonFiles/dataAnalysis/datasetOverlap_topK.py"

X_PATH="/scratch/mgirishnair/Thesis/MotionCLIP_ready_datasetFinalAll_1-120/X.npy"
Y_PATH="/scratch/mgirishnair/Thesis/MotionCLIP_ready_datasetFinalAll_1-120/y.npy"
BABEL_LABELS_PATH="/scratch/mgirishnair/Thesis/MotionCLIP_experiment/babel60_labels.txt"
CHECKPOINT_PATH="/scratch/mgirishnair/Thesis/MotionCLIP_experiment/classes-model/checkpoint_0200.pth.tar"

OUTPUT_DIR="/scratch/mgirishnair/Thesis/MotionCLIP_experiment/dataAnalysis/ntu_babel_overlap/chunks/topK/new"
